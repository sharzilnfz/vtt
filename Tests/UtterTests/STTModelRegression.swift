...
func runSTTModelRegressions() throws {
    ...
    let suite = "Utter.stt.tests.\(UUID().uuidString)"
    ...
    defaults.set("{\"builtIn\":{\"_0\":\"tdtCtc110m\"}}".data(using: .utf8)!, forKey: "utter.stt.model.selection")
...
func runSTTBannerRegressions() throws {
    ...
    let settings = RefinementSettingsStore(defaults: UserDefaults(suiteName: "Utter.stt.banner.\(UUID().uuidString)")!)
