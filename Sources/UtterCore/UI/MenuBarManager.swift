...
public final class MenuBarManager: NSObject, NSMenuDelegate, NSPopoverDelegate {
    ...
    public override init() {
        ...
        if let button = statusItem?.button {
            button.image = NSImage(systemSymbolName: "waveform", accessibilityDescription: "Utter Dictation")
            button.target = self
        ...
        let heading = NSMenuItem(title: "Utter", action: nil, keyEquivalent: "")
    ...
    public func update(
        ...
        statusItem?.button?.toolTip = "Utter"
