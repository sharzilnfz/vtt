...
struct RenderPreview {
    ...
    static func main() {
        ...
        renderToPNG(
            ...
            size: previewSize,
            path: "/tmp/vtt-dashboard-dark.png"
        )
        ...
        renderToPNG(
            ...
            size: previewSize,
            path: "/tmp/vtt-dashboard-light.png"
        )
        ...
        renderToPNG(
            ...
            path: "/tmp/vtt-indicator-pill.png"
        )
        ...
        renderToPNG(
            ...
            path: "/tmp/vtt-menubar-popover-dark.png"
        )
        ...
        renderToPNG(
            view: popoverLight,
            size: CGSize(width: 320, height: 320),
            path: "/tmp/vtt-menubar-popover-light.png"
        )
