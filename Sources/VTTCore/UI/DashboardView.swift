...
public struct DashboardView: View {
    ...
    public var body: some View {
        ...
        .background(
            ZStack {
                ...
                VTTTheme.canvasBg(isDark: isDark)
                    .ignoresSafeArea()
    ...
    private var bannerColor: Color {
        ...
        case .info: return VTTTheme.stateSyncing(isDark: isDark)
        case .warning: return VTTTheme.stateHolding(isDark: isDark)
        case .error: return VTTTheme.stateConflict(isDark: isDark)
        case .success: return VTTTheme.stateSynced(isDark: isDark)
        }
    }
